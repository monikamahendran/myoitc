...
public class AbsentTrackerEmployeList extends BaseActivity implements Response.ErrorListener, Response.Listener<String>, Listeners.POSTMethodListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setToolbarTitle( "Absent Employee List" );
        setContentView( R.layout.activity_absent_tracker_employe_list );
    ...
    private void setAdapter() {
        employeeListAdapter = new EmployeeListAdapter( AbsentTrackerEmployeList.this, employeeListBeans, from );
            ...
            if (newJsObj.getBoolean( "success" )) {
                ...
                if (outJson.length() > 0) {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        ...
                        employeeListBean.setEmp_id( jsonObject.optString( "id" ) );
                        employeeListBean.setEmp_name( jsonObject.optString( "name" ) );
                        employeeListBean.setEmp_list_date( jsonObject.optString( "month" ) );
                        employeeListBean.setEmp_total( jsonObject.optString( "working" ) );
                        employeeListBean.setEmp_work_hrs( jsonObject.optString( "hours" ) );
                        employeeListBean.setEmp_leave( jsonObject.optString( "leave" ) );
    ...
    private void getEmployeeList() {
        try {
            ...
            StringMethodRequest postMethodRequest = new StringMethodRequest( this, Request.Method.POST, Utils.AbsentEmployeeListAPI, mParams, true, this, this, this, 1 );
